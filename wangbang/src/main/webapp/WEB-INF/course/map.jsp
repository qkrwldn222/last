...
var positions = [  // 마커의 위치
					/*
						...
						35.15442
						129.145
						new kakao.maps.LatLng(35.15373, 129.0557),
			            new kakao.maps.LatLng(35.15442, 129.145),
					*/
	            	...
	            	<c:if test="${mList!=null }">
						<c:forEach var="vo" items="${mList}">
		            		new kakao.maps.LatLng(<c:out value="${vo.wgsx}"/>, <c:out value="${vo.wgsy}"/>),
		            		
		            	</c:forEach>
		            		new kakao.maps.LatLng(35.153, 129.0557)
		            </c:if> 
