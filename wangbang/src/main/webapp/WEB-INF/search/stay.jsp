...
<div class="card shadow mb-4">
        <div class="row">
	         <div class="card-header py-3">
	              <h2 class="m-0 font-weight-bold text-primary text-center">부산숙박	</h2>
	              </div>
	          </div>
	   ...
	   <div class="col-12 m-b-30" id="root">                 
		  ...
		  class Stay extends React.Component{
			  ...
			  componentWillMount(){
				  var _this=this;
				  axios.get('http://localhost:8080/wang/search/stay_data.do',{
					  params:{
						  page:1
					  }
				  }).then((response)=>{
			  ...
			  render(){
                  const html=this.state.data_json.map((m)=>
                     <div className="col-md-6 col-lg-3">
                                <div className="card">
                                  <a href={"../search/stay_detail.do?dataSid="+m.dataSid}><img className="img-fluid" src={m.mainimgthumb} alt=""/></a>
